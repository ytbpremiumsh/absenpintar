...
import { GUIDES } from "@/data/panduanGuides";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <section className="max-w-6xl mx-auto px-4 pt-12 pb-6 text-center">
        ...
        >
          Pilih peran Anda di bawah untuk mempelajari step-by-step penggunaan
          ATSkolla — lengkap dengan screenshot di setiap menu.
        </motion.p>
      </section>
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-44 overflow-hidden bg-slate-100">
                    ...
                    />
                    <div
                      className={`absolute inset-0 bg-gradient-to-tr ${g.color} opacity-80 mix-blend-multiply`}
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />

                    {/* Floating icon */}
                    <motion.div
                      className={`absolute top-4 left-4 h-12 w-12 rounded-2xl bg-white/95 backdrop-blur flex items-center justify-center shadow-lg`}
                  ...
                  <div className="p-5">
                    ...
                    <ul className="space-y-1.5 mb-5">
                      {g.highlights.map((h, i) => (
                        ...
                        >
                          <Sparkles className="h-3 w-3 text-[#5B6CF9] shrink-0" />
                          <span>{h}</span>
                        </li>
                      ))}
                    </ul>
                    ...
                    <div
                      className={`inline-flex items-center gap-2 text-sm font-bold bg-gradient-to-r ${g.color} bg-clip-text text-transparent group-hover:gap-3 transition-all`}
                    >
                      Buka Panduan
